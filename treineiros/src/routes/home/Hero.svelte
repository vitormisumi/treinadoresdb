<section id="hero">
  <div id="field-fade" />
  <img src="/treineiros/treineiros/src/static/images/field.png" alt="campo de futebol" id="field-img" />
...
<style>
  ...
  #field-fade {
    ...
    grid-row: 1 / 5;
    z-index: 1;
    background: linear-gradient(90deg, rgba(39, 41, 50, 0) 0%, #272932 100%);
  }
  ...
  #coaches-fade {
    ...
    align-self: bottom;
    z-index: 200;
    background: linear-gradient(180deg, #27293200 0%, #272932 100%);
  }
